...
export class CourseEffects {
    ...
    getCourses$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(() => this.coursesService.get().pipe(
    ...
    addCourse$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(({ course }) => this.coursesService.add(course).pipe(
    ...
    joinCourse$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(({ studentId, courseId }) => this.coursesService.join(studentId, courseId).pipe(
                switchMap(({ course, student }) => [
    ...
    leaveCourse$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(({ studentId, courseId }) => this.coursesService.leave(studentId, courseId).pipe(
                switchMap(({ course, student }) => [
